...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    dom_munger:{
      ...
      update: {
        ...
        src:'index.html',
        dest: '../Spark-backend/public/index.html'
      }
    },
    cssmin: {
      main: {
        src:['temp/app.css','<%= dom_munger.data.appcss %>'],
        dest:'../Spark-backend/public/app.full.min.css'
      }
    },
    concat: {
      main: {
    ...
    uglify: {
      main: {
        src: 'temp/app.full.js',
        dest:'../Spark-backend/public/app.full.min.js'
      }
    },
    htmlmin: {
      main: {
        ...
        files: {
          '../Spark-backend/public/index.html': '../Spark-backend/public/index.html'
        }
      }
    },
    ...
    //   main:{
    //     files: [{
    //       expand: true, cwd:'../Spark-backend/public/',
    //       src:['**/{*.png,*.jpg}'],
    //       dest: '../Spark-backend/public/'
    //     }]
    //   }
    // },
    karma: {
  ...
  grunt.registerTask('build',['clean:before','copy:temp','less','dom_munger','ngtemplates','cssmin','concat','ngAnnotate','uglify','copy:dist','htmlmin','clean:after']);
